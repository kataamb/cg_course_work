...
#include <memory>
#include "../course_work/renderer.h"
...
QT_MOC_LITERAL(1, 9, 19), // "ready_pixmap_signal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8) // "QPixmap*"

    },
    "Renderer\0ready_pixmap_signal\0\0QPixmap*"
};
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ready_pixmap_signal((*reinterpret_cast< QPixmap*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Renderer::*)(QPixmap * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Renderer::ready_pixmap_signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Renderer::ready_pixmap_signal(QPixmap * _t1)
{
